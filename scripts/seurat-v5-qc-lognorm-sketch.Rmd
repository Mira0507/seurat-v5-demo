...
pref <- 'seurat-v5-qc-lognorm-sketch'
...
In log-normalization, we normalize single cells by dividing feature counts per cell by the total counts 
for that cell, followed by multiplication with the `scale.factor`, and then transforming to the natural 
log scale using `log1p`.
